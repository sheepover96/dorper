...
# %%
from feature.racer_info_base import RacerInfoBase
racer_info_base = RacerInfoBase(race_info_list=valid_race_result_list_18, year=2018)
racer_info_base.extract_feature()
racer_info_base.save('./feature_pkls/racer_info_base_2018_all.pkl')
...
#%%
from feature.racer_win_rate_year import RacerInfoWinRateYear
racer_win_rate_period = RacerInfoWinRateYear(race_info_list=valid_race_result_list_18, year=2018)
racer_win_rate_period.extract_feature()
racer_win_rate_period.save('./feature_pkls/racer_win_rate_year_2018.pkl')
