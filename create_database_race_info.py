...
def main():
    ...
    for year in range(2000, 2019):
        race_metadata_year = race_metadata[race_metadata['year']==2012]
        print(len(race_metadata_year))
        ...
        for idx, race_num_obj in enumerate(race_result_num_year_all):
            ...
            new_race_info = RaceInfo(race_num=race_num, year=year, is_race_no_flying=is_race_no_flying, is_race_times_record_valid=is_race_times_record_valid)
