...
def main():
    ...
    for idx, data_row in race_result.iterrows():
        ...
        if np.isnan(data_row['lane1_result_rank']):
            lane1_result_rank = None
        else:
            lane1_result_rank = int(data_row['lane1_result_rank'])

        if np.isnan(data_row['lane2_result_rank']):
            lane2_result_rank = None
        else:
            lane2_result_rank = int(data_row['lane2_result_rank'])

        if np.isnan(data_row['lane3_result_rank']):
            lane3_result_rank = None
        else:
            lane3_result_rank = int(data_row['lane3_result_rank'])

        if np.isnan(data_row['lane4_result_rank']):
            lane4_result_rank = None
        else:
            lane4_result_rank = int(data_row['lane4_result_rank'])

        if np.isnan(data_row['lane5_result_rank']):
            lane5_result_rank = None
        else:
            lane5_result_rank = int(data_row['lane5_result_rank'])

        if np.isnan(data_row['lane6_result_rank']):
            lane6_result_rank = None
        else:
            lane6_result_rank = int(data_row['lane6_result_rank'])
