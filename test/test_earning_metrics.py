...
def test_sanrentan_earning():
    ...
    payment1, revenue1 = em.earning_sanrentan(test_win_prob, target_comb_dic, threshold1)
    assert payment1 == 100 and revenue1 == race_odds
    payment2, revenue2 = em.earning_sanrentan(test_win_prob, target_comb_dic, threshold2)
    assert payment2 == 300 and revenue2 == race_odds

def test_sanrenfuku_earning():
    test_win_prob =[0.4, 0, 0.6, 0, 0, 0,
                    0.6, 0.3, 0.1, 0, 0, 0,
                    0, 0.7, 0.1, 0, 0.2, 0,
                    0, 0, 0.1, 0.8, 0, 0.1,
    ...
    assert payment1 == 100 and revenue1 == race_odds
    payment2, revenue2 = em.earning_sanrenfuku(test_win_prob, target_comb_dic, threshold2)
